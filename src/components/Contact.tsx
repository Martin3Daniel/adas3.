...
export default function Contact() {
  const openWhatsApp = () => {
    ...
    window.open(`https://wa.me/2348112765106?text=${msg}`, '_blank');
  };
          ...
          >
            ...
            <div className="bg-[#F8F9FA] rounded-2xl p-7 border border-gray-100">
              ...
              <div className="space-y-4">
                <a
                  href="https://wa.me/2348112765106?text=Hello%20Adas%20Concepts!%20I%20would%20like%20to%20book%20an%20appointment%20for%20your%20automobile%20services."
                  target="_blank"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-[#1A1A1A] group-hover:text-[#990000] transition-colors">+234 811 276 5106</p>
                  </div>
                </a>
                <a href="tel:+2348112765106" className="flex items-center gap-4 group">
                  <div className="w-11 h-11 rounded-xl bg-[#990000]/10 flex items-center justify-center group-hover:bg-[#990000] transition-colors duration-300">
                ...
                <a href="tel:+2349165040772" className="flex items-center gap-4 group">
                  <div className="w-11 h-11 rounded-xl bg-[#990000]/10 flex items-center justify-center group-hover:bg-[#990000] transition-colors duration-300">
                    <Phone size={20} className="text-[#990000] group-hover:text-white transition-colors duration-300" />
                  </div>
                  <div>
                    <p className="text-xs text-gray-400">Secondary Line</p>
                    <p className="font-semibold text-[#1A1A1A] group-hover:text-[#990000] transition-colors">+234 916 504 0772</p>
                  </div>
                </a>
                <a href="tel:+2348098504650" className="flex items-center gap-4 group">
                  <div className="w-11 h-11 rounded-xl bg-[#990000]/10 flex items-center justify-center group-hover:bg-[#990000] transition-colors duration-300">
                    <Phone size={20} className="text-[#990000] group-hover:text-white transition-colors duration-300" />
                  </div>
                  <div>
                    <p className="text-xs text-gray-400">Customer Care Line</p>
                    <p className="font-semibold text-[#1A1A1A] group-hover:text-[#990000] transition-colors">+234 809 850 4650</p>
                  </div>
                </a>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-[#1A1A1A]">114 Okesuna St, Lagos Island, Lagos 102273, Lagos</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            <div className="bg-[#F8F9FA] rounded-2xl border border-gray-100 overflow-hidden h-full min-h-[400px]">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.718!2d3.379!3d6.527!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2s114%20Okesuna%20Street%2C%20Lagos%20Island%20102273%2C%20Lagos%2C%20Nigeria!5e0!3m2!1sen!2sng!4v1"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
